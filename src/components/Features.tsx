      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`p-4 sm:p-6 rounded-xl border-2 ${colorClasses[feature.color as keyof typeof colorClasses]} backdrop-blur-sm transition-all duration-300 hover:scale-105 hover:shadow-lg`}
            >
              <feature.icon className="w-8 h-8 sm:w-10 sm:h-10 mb-3 sm:mb-4" />
        ...
        <div className="mt-10 sm:mt-16 text-center px-2">
          <p className="text-lg sm:text-xl md:text-2xl text-foreground/90 italic">
            "Of je nou komt om te winnen, te zingen of gewoon voor de lol..."
          </p>
          <p className="text-base sm:text-lg md:text-xl text-neon-pink mt-3 sm:mt-4 font-semibold">
